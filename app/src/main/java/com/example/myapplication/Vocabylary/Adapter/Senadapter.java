...
public class Senadapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        String newString = TabFragment2.sentenceList.get(position).getSENTENCE().replaceAll(TabFragment2.current_word.toLowerCase().trim(), "<font color='red'>"+TabFragment2.current_word.toLowerCase().trim()+"</font>");
