...
import com.example.myapplication.Vocabylary.Adapter.MyListAdapter;
...
import static com.example.myapplication.MainActivity.contactList;
...
public class Vocabulary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      if(contactList.size()==0){
          ...
          Toasty.info(Vocabulary.this,"Error Nothing found");
...
//            textView.setText("Total Words : \n"+String.valueOf(contactList.size())+"\nCurrent score : \n"+String.valueOf(bestscore));
        ...
        System.out.println(Vocabulary.sizee.getInt("size", 0));
        ...
        sort.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Context wrapper = new ContextThemeWrapper(Vocabulary.this, R.style.YOURSTYLE1);
                if (isDark) {
                    wrapper = new ContextThemeWrapper(Vocabulary.this, R.style.YOURSTYLE);

                } else {
                    wrapper = new ContextThemeWrapper(Vocabulary.this, R.style.YOURSTYLE1);
                }
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        Toasty.info(Vocabulary.this, "You Clicked : " + item.getTitle(), Toast.LENGTH_SHORT).show();
                        return true;
                    }
                });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (WalkThrough.isfirst) {
            ...
            new MaterialTapTargetSequence()
                    .addPrompt(new MaterialTapTargetPrompt.Builder(Vocabulary.this)
