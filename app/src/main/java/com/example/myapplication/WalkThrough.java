...
import com.shashank.sony.fancywalkthroughlib.BuildConfig;
...
public class WalkThrough extends FancyWalkthroughActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(checkFirstRun()) {
            FancyWalkthroughCard fancywalkthroughCard1 = new FancyWalkthroughCard("Collect Words", "Your can store unknown words, which you face daily.", R.drawable.ic_add);
            FancyWalkthroughCard fancywalkthroughCard2 = new FancyWalkthroughCard("Collect Notes With Image", "Make daily notes for future reading.", R.drawable.ic_add);
            FancyWalkthroughCard fancywalkthroughCard3 = new FancyWalkthroughCard("Listen Music", "You can listen music while studying.", R.drawable.ic_add);
            FancyWalkthroughCard fancywalkthroughCard4 = new FancyWalkthroughCard("Follow Promotodo", "You can maintain promodo for a better focus on time.", R.drawable.ic_add);
