...
import com.example.myapplication.Phrase.Adapter.SectionsPagerAdapter;
import com.example.myapplication.R;
import com.google.android.material.tabs.TabLayout;

public class PhraseDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Phrase Section"));
